...
public class PlayerScript : MonoBehaviour
{
	...
	private void OnTriggerEnter(Collider other)
	{
        ...
        else if (other.transform.name == "Principal of the Thing" && principalKillsYou)
        {
            this.gameOver = true;
        }
		else if (other.transform.name == "Vice Principal of the Thing" && principalKillsYou)
        {
            this.gameOver = true;
        }
        else if (other.transform.name == "Marcello")
        {
            this.gameOver = true;
        }
